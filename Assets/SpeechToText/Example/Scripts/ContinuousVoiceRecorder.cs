...
public class ContinuousVoiceRecorder : MonoBehaviour
{
    ...
    private void Start()
    {
        _sttClient = new DeepSpeech(Application.persistentDataPath + "/Models/" + ModelPath);
        _sttClient.EnableExternalScorer(Application.persistentDataPath + "/Models/" + ExternalScorerPath);
